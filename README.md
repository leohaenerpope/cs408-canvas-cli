...
Also, in my .gitignore file, it doesn't ignore any python-related files as the virtual environment that is created automatically ignores them, and in my experience with this project I didn't run into any times when other cache files were created.
